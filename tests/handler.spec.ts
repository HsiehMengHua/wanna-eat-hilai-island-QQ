...
describe('Test Index', () => {
    ...
    it('given one of check process fails, the others should continue', async () => {
        const checkItems: CheckItem[] = [
            { name: 'first', pageUrl: 'https://inline.app/booking/-NeqTSgDQOAYi30lg4a7:inline-live-3/-NeqTStJZDIBQHEMSDI8', bookingSize: 2 },
            { name: 'second', pageUrl: 'https://tw.eztable.com/restaurant/17565', bookingSize: 2 },
        ];
